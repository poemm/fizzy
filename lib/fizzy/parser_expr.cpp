...
struct LabelPosition
{
    ...
    size_t code_offset{0};                  ///< The target instruction code offset.
    size_t immediates_offset{0};            ///< The target instruction immediates offset.
    ...
    while (continue_parsing)
    {
        ...
        case Instr::block:
        {
            ...
            label_positions.push_back(
                {Instr::block, code.instructions.size(), code.immediates.size(), arity != 0});
        ...
        case Instr::loop:
        {
            ...
            label_positions.push_back(
                {Instr::loop, code.instructions.size(), code.immediates.size(), false});
            break;
        }
        ...
        case Instr::if_:
        {
            ...
            label_positions.push_back(
                {Instr::if_, code.instructions.size(), code.immediates.size(), arity != 0});
